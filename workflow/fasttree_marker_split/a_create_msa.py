...
from workflow.config import DEBUG, DIR_OUT_FASTTREE_MARKER_SPLIT
...
class FastTreeMarkerSplitCreateMsa(LuigiTask):
    ...
    def run(self):
        log(f'FastTreeMarkerSplitCreateMsa(target_pct={self.target_pct})', title=True)
