...
class FastTreeMarkerSplitDecorateFastTree(LuigiTask):
    ...
    def requires(self):
        return {
            'tree': FastTreeMarkerSplitRootFastTree(target_pct=self.target_pct),
    ...
    def run(self):
        log(f'FastTreeMarkerSplitDecorateFastTree(p={self.target_pct})', title=True)
