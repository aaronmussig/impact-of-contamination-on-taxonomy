...
from workflow.fasttree_marker_split.random_c_root_fasttree import FastTreeMarkerSplitRandomRootFastTree
from workflow.model.luigi import LuigiTask, LocalTargetTree
from workflow.util.log import log


class FastTreeMarkerSplitRandomDecorateFastTree(LuigiTask):
    ...
    def requires(self):
        return {
            'tree': FastTreeMarkerSplitRandomRootFastTree(target_pct=self.target_pct, replicate_id=self.replicate_id),
    ...
    def run(self):
        log(f'FastTreeMarkerSplitRandomDecorateFastTree(p={self.target_pct}, r={self.replicate_id})', title=True)
