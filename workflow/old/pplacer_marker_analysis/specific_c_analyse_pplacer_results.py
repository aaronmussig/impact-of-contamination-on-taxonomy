...
from workflow.pplacer_marker_analysis.specific_b_run_pplacer import PplacerMarkerAnalysisSpecificRunPplacer
from workflow.util.log import log

sys.setrecursionlimit(10000)


class PplacerMarkerAnalysisSpecificAnalysePplacerResults(LuigiTask):
    ...
    def requires(self):
        return {
            ...
            'tree': PplacerMarkerAnalysisSpecificRunPplacer(
                pplacer_domain=self.pplacer_domain,
                target_pct=self.target_pct,
                congruence=self.congruence,
                gids=self.gids
    ...
    def output(self):
        return LocalTargetTsv(os.path.join(self.root_dir, 'results.tsv'))

    def run(self):
        log(f'PplacerMarkerAnalysisSpecificAnalysePplacerResults('
