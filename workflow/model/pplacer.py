...
from workflow.util.system import get_proc_memory_gb
...
class Pplacer(object):
    ...
    def run(self, cpus, model, ref_pkg, json_out, msa_file, pplacer_out,
        ...
        Raises:
            Exception: if a non-zero exit code, or if the json output
    ...
    def _worker(self, args, out_q, pplacer_out, pid):
        ...
        with subprocess.Popen(args, stdout=subprocess.PIPE, encoding='utf-8') as proc:
            ...
            if proc.returncode != 0:
                raise Exception('An error was encountered while '
    ...
    def tog(self, pplacer_json_out, tree_file):
        ...
        Raises:
            Exception: If a non-zero exit code is returned, or the tree file
                          isn't output.
        """
