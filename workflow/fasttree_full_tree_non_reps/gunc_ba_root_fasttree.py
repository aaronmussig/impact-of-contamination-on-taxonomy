...
class FastTreeFullSetNonRepsCreateBatchesGuncFastTreeRoot(LuigiTask):
    ...
    def requires(self):
        return {
            'tree': FastTreeFullSetNonRepsCreateBatchesGuncFastTree(congruence=self.congruence, target_pct=self.target_pct),
    ...
    def run(self):
        log(f'FastTreeFullSetNonRepsCreateBatchesGuncFastTreeRoot(congruence={self.congruence}) (pct={self.target_pct})',
            title=True)
