...
class FastTreeMarkerAnalysisDecorateGuncFastTree(LuigiTask):
    ...
    def run(self):
        log(f'FastTreeMarkerAnalysisDecorateGuncFastTree(c={self.congruence}, p={self.target_pct})', title=True)
