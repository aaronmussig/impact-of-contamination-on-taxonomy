...
class V2FastTreeMarkerSplitDecorateFastTree(LuigiTask):
    ...
    def requires(self):
        return {
            'tree': V2FastTreeMarkerSplitRootFastTree(remove_pct=self.remove_pct),
    ...
    def run(self):
        log(f'V2FastTreeMarkerSplitDecorateFastTree(remove_pct={self.remove_pct})', title=True)
