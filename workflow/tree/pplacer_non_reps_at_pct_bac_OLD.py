...
from workflow.config import DEBUG, PPLACER_R207_ARC_PATH, \
    DIR_OUT_PPLACER_ARC_NON_REPS, DIR_OUT_PPLACER_BAC_NON_REPS, PPLACER_R207_BAC_PATH
...
class PplacerNonRepsAtPctBac(LuigiTask):
    ...
    def output(self):
        return LocalTarget(os.path.join(OUTPUT_DIRECTORY, 'output.tree'))
    ...
    def run(self):
        ...
        pplacer.run(min(mp.cpu_count(), 64), 'wag', PPLACER_R207_BAC_PATH, pplacer_json_out, path_msa_out, pplacer_out)
