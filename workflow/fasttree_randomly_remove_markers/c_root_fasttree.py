...
from workflow.fasttree_randomly_remove_markers.b_run_fasttree import FastTreeRandomlyRemoveMarkersRunFastTree
from workflow.model.luigi import LuigiTask
from workflow.util.log import log


class FastTreeRandomlyRemoveMarkersRootFastTree(LuigiTask):
    ...
    def requires(self):
        return {
            'tree': FastTreeRandomlyRemoveMarkersRunFastTree(target_pct=self.target_pct,
    ...
    def run(self):
        log(f'FastTreeRandomlyRemoveMarkersRootFastTree(pct={self.target_pct}, r={self.replicate_id})', title=True)
