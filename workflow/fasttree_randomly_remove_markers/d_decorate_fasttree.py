...
class FastTreeRandomlyRemoveMarkersDecorateFastTree(LuigiTask):
    ...
    def requires(self):
        return {
            'tree': FastTreeRandomlyRemoveMarkersRootFastTree(target_pct=self.target_pct,
    ...
    def run(self):
        log(f'FastTreeRandomlyRemoveMarkersDecorateFastTree(p={self.target_pct}, r={self.replicate_id})', title=True)
