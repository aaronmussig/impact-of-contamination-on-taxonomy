...
class FastTreeFullTreeAndFailedNoTrimDecorate(LuigiTask):
    ...
    def output(self):
        return LocalTargetTree(
            os.path.join(self.root_dir, 'phylorank', 'fasttree_undecorated_rooted_decorated.tree'))

    def run(self):
        log(f'FastTreeFullTreeAndFailedNoTrimDecorate', title=True)
